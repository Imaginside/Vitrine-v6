    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:rgb(247, 247, 247); padding-bottom:20px;">
        <tr>
            <td align="center" colspan="2">
                <p><strong><?= ucfirst($data['widget-contact-form-name']) ?></strong>, voici le récapitulatif de votre message écrit à <a href="<?= $_URLSite ?>" target="_blank" style="font-weight:bold;color:#3a3a3a;"><?= $_NomSite ?></a>.</p>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="2">
                ...
                <table width="600px" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFF">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="color:#c7c7c7; font-size:26px;padding:30px;">
                                        ...
                                        <span style="font-size:35px; font-weight:bold;">MERCI !</span><br>
                                        <span style="color:#FFF;font-weight:bold;"><?= ucfirst($data['widget-contact-form-name']) ?></span>, <br>votre message a été envoyé avec succés !
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td colspan="2"><h2 style="color:#3a3a3a; font-size:30px; padding:0 20px; margin-bottom:0px;">#récapitulatifDeVotreMessage</h2></td>
                                </tr>
                                <tr>
                                    <td style="padding:20px 20px 0 30px;color:#3a3a3a;" width="100px">
                    ...
                    <tr>
                        <td colspan="2" style="padding:30px;">
                            <h2 style="font-size:30px;padding:0;margin:0;">#vosInformationsDeContact</h2>
                            <p style="margin:4px 0;padding:0;">Pour vous recontacter, vous nous avez donné les informations de contact suivant :</p>
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:5px 0;">
                                    <tr>
                                        <td width="50px"><img src="<?= $_URLSite.IMAGES ?>mail/picto-phone-black.png" width="35px" height="35px" border="0" alt="coche"></td>
                                        <td>
                                            <p style="margin:4px 0;padding:0;"><?= $data['widget-contact-form-phone'] ?></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="50px"><img src="<?= $_URLSite.IMAGES ?>mail/picto-mail-black.png" width="35px" height="35px" border="0" alt="coche"></td>
                                        <td>
                                            <p style="margin:4px 0;padding:0;"><?= $data['widget-contact-form-email'] ?></p>
                                        </td>
                                    </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" style="padding:30px;">
                            ...
                            <p style="margin:4px 0;padding:0;">Lors de l'envoi du message, vous avez coché la case suivante :</p>
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:5px 0;">
                                <tr>
                            ...
                            <p style="margin:8px 0;padding:0;">Vous disposez d’un droit d’accès, de rectification et de suppression relatif aux données personnelles vous concernant ainsi que de celui de vous opposer à ce que ces données fassent l’objet d’un traitement, que vous pouvez exercer en écrivant à : <?= $_NomSite . ' - ' . $_AddressSite . ' - ' . $_ZipcodeSite . ' ' . $_TownSite ?>.</p>
                            <p style="margin:8px 0 0;padding:0;"><strong>Opposition au démarchage téléphonique</strong> : Si vous ne souhaitez pas faire l'objet de prospection commerciale téléphonique, vous pouvez vous inscrire gratuitement sur la liste d'opposition au démarchage téléphonique Bloctel. Pour en savoir plus sur les modalités d'inscription, consultez le site Internet <a href="http://www.bloctel.gouv.fr/" target="_blank" style="color:#3a3a3a;">www.bloctel.gouv.fr</a>. Les consommateurs inscrits sur cette liste ne pourront plus être démarchés téléphoniquement par un professionnel, sauf en cas de relations contractuelles préexistantes avec ce professionnel lors du démarchage téléphonique.</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" bgcolor="#303030">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td width="100%" style="padding:15px 30px;">
                                        <h2 style="color:#FFF; font-size:30px;padding:0;margin:0 0 8px">#nousContacter</h2>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td width="35px"><img src="<?= $_URLSite.IMAGES ?>mail/picto-phone-white.png" width="24px" height="24px" border="0" alt="Tél. :"></td>
                                                <td style="padding-bottom:5px;"><a href="tel:<?= $_TelLinkSite ?>" style="font-weight:bold;color:#FFF;"><?= $_TelSite ?></a></td>
                                            </tr>
                                            <tr>
                                                <td width="35px"><img src="<?= $_URLSite.IMAGES ?>mail/picto-mail-white.png" width="24px" height="24px" border="0" alt="Mail. :"></td>
                                                <td style="padding-bottom:5px;"><a href="mailto:<?= $_MailSite ?>" style="font-weight:bold;color:#FFF;"><?= $_MailSite ?></a></td>
                                            </tr>
                                            <tr>
                                                <td width="35px"><img src="<?= $_URLSite.IMAGES ?>mail/picto-website-white.png" width="24px" height="24px" border="0" alt="Site web :"></td>
                                                <td style="padding-bottom:5px;"><a href="<?= $_URLSite ?>" style="font-weight:bold;color:#FFF;" target="_blank"><?= $_WebSite ?></a></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="180px" height="180px">
        ...
        <tr>
            <td align="center">
                <table width="600px" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td align="center">
                            <a href="<?= $_URLSite ?>" target="_blank"><img src="<?= $_URLSite.$_LogoSite ?>" alt="Logo <?= $_NomSite ?>" height="80px"></a>
                        </td>
