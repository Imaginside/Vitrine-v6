...
<section id="page-title"';
    ...
    if(isset($PageTitleVideo) && $PageTitleVideo != '') {
        echo 'data-vide-bg="/site/Themes/theme1/video/explore/explore" data-vide-options="position: 0% 50%"';
    }
...
if(isset($PageTitleImg) && $PageTitleImg != '') {
    ...
    if(isset($PageTitleVideo) && $PageTitleVideo != '') {
        echo '<div style="position: absolute; z-index: -1; top: 0px; left: 0px; bottom: 0px; right: 0px; overflow: hidden; background-size: cover; background-color: transparent; background-repeat: no-repeat; background-position: 0% 50%; background-image: none;"><video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 0%; transform: translate(0%, -50%); visibility: visible; opacity: 1; width: 1440px; height: auto;"><source src="' . $PageTitleVideo . '.mp4" type="video/mp4"><source src="' . $PageTitleVideo . '.webm" type="video/webm"><source src="' . $PageTitleVideo . '.ogv" type="video/ogg"></video></div>';
    }
